...
CREATE UNIQUE INDEX "account_provider_accountid_uq" ON "account" USING btree ("provider_id","account_id");--> statement-breakpoint
CREATE UNIQUE INDEX "account_user_provider_uq" ON "account" USING btree ("user_id","provider_id");--> statement-breakpoint
